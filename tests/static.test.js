...
for(const name of ["Reostatos_1_rama_1iny","Reostatos_1_rama_2iny","Reostatos_1_nodo_3_ramas_1iny","Reostatos_1_nodo_3_ramas_3iny"])assert.ok(app.includes(name),name+" ausente");
for(const label of ["1 nodo · 2 ramas · 1 inyección","1 nodo · 2 ramas · 2 inyecciones","1 nodo · 3 ramas · 1 inyección","1 nodo · 3 ramas · 3 inyecciones"])assert.ok(app.includes(label),label+" ausente");
